...
<body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="hidden-xs">Maulidia Ramadanti</span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                                <li class="user-header">
                                    ...
                                    <p>
                                        Maulidia Ramadanti - Web Developer
    ...
    <!-- Morris.js charts -->
    <script src="{{ url('') }}/laravel/vendor/almasaeed2010/adminlte/bower_components/raphael/raphael.min.js">
    </script>
    <script src="{{ url('') }}/laravel/vendor/almasaeed2010/adminlte/bower_components/morris.js/morris.min.js">
    </script>
    <!-- Sparkline -->
    <script
